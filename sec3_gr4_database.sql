...
('Band of Brothers', '9780743224543', 'nonfiction', '2001-10-01', 245.00, 'Simon & Schuster', 'The story of Easy Company, 506th Parachute Infantry Regiment, 101st Airborne Division.', (SELECT authorID FROM authors WHERE authorName='Stephen E. Ambrose'), (SELECT adminID FROM admins WHERE email='ludwig@nairarm.com')),
...
('Swimming in the Dark', '9780062890009', 'fiction', '2020-06-02', 300.00, 'William Morrow', 'A story of forbidden love set in 1980s Poland.', (SELECT authorID FROM authors WHERE authorName='Tomasz Jedrowski'), (SELECT adminID FROM admins WHERE email='ludwig@nairarm.com')),
